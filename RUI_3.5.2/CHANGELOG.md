...
- RUI-633: WatchDog support (should update bootloader)
...
### Changed
- Keep older api: api.system.firmwareVersion.get(), api.system.cliVersion.get(), api.system.modelId.get()
- Keep older api: api.system.firmwareVersion.set(), api.system.cliVersion.set(), api.system.modelId.set()
