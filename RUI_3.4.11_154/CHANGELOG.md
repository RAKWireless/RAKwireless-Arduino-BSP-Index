...
### Changed
- Disable the mechanism that detect gpio for going into boot mode
...
### Changed
- For RAK3172, give different default values to HF board and LF board.
- For RAK3172, AT command handler can distinguish HF board or LF board.
